...
export const scheduleDays = [
  ...
  },
  {
    ...
    date: "12 Aralık",
    events: [
      { title: "İTÜ AUV Takımı - Otonom Sualtı Aracı", time: "09:55-10:35", track: "Burçak Eyüboğlu Kampüsü - Oditoryum", speaker: "Burçak Eyüboğlu İlkokulu 3-4.Sınıflar ve Doğu Ataşehir İlkokulu 3-4.Sınıflar" },
      { title: "İTÜ AUV Takımı - Otonom Sualtı Aracı", time: "10:45-11:25", track: "Burçak Eyüboğlu Kampüsü - Oditoryum", speaker: "Burçak Eyüboğlu Ortaokulu 5-6-7.sınıflar" },
      { title: "İTÜ AUV Takımı - İnsansız Sualtı Aracı", time: "12:50-13:30", track: "Çamlıca Kampüsü - E-Hall", speaker: "Çamlıca İlkokulu 3-4.Sınıflar" },
      { title: "İTÜ AUV Takımı - İnsansız Sualtı Aracı", time: "13:40-14:20", track: "Çamlıca Kampüsü - E-Hall", speaker: "Çamlıca Ortaokulu 5.-6.-7.sınıflar" },
      { title: "İTÜ AUV Takımı - İnsansız Sualtı Aracı", time: "14:30-15:10", track: "Çamlıca Kampüsü - E-Hall", speaker: "Lise Hazırlık, 9.-10.Sınıflar" },
    ],
  },
];
...
export const speakers = [
  ...
  },
  {
    ...
    bio: "İTÜ ATA Takımı, İstanbul Teknik Üniversitesi'nde insansız hava aracı teknolojileri üzerine çalışan bir araştırma ve geliştirme ekibidir. Takım, yenilikçi İHA çözümleri geliştirmektedir. Özellikle otonom uçuş sistemleri, gerçek zamanlı görüntü işleme ve yapay zeka destekli navigasyon konularında uzmanlaşmışlardır.",
    image: "/itu_ata/itu_ata.jpeg",
    experience: "5+ yıl İHA teknolojisi araştırması ve geliştirme, 10+ farklı İHA projesi tamamlama",
    achievements: "TÜBİTAK Teknoloji Yarışmaları İHA kategorisinde 1.lik, RoboTürk yarışmalarında 3 kez üst üste başarı ödülü, 2 uluslararası yayın ve 3 patent başvurusu",
    session: "İnsansız Hava Aracı",
