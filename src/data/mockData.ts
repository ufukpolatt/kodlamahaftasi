...
export const workshops = [
  ...
  },
  {
    ...
    image: "/",
    fullDesc: "Öğrenciler, 3D kalemle temel geometrik şekiller, çiçek, yıldız ve gözlük figürleri tasarlayacaktır. Bu etkinlikle çocuklar el becerilerini geliştirir, yaratıcılıklarını kullanır ve 3D tasarımın temellerini öğrenirler.",
    instructor: "Anaokulu Öğretmenleri",
    duration: "45 dakika",
    prerequisites: "Yok",
  },
  {
    ...
    image: "/",
    fullDesc: "Öğrenciler, Makey Makey aracılığıyla muz, mandalina gibi günlük nesneleri dokunarak piyano çalacaklar. Etkinlik sayesinde çocuklar, basit elektrik devrelerinin nasıl çalıştığını deneyimleyecek, dokunmatik uyarılarla müzik üretmenin mantığını keşfedecek ve problem çözme, iş birliği ile yaratıcılık becerilerini geliştireceklerdir. Ayrıca, meyvelerle müzik yapma etkinliği, öğrenmeyi eğlenceli hâle getirerek çocukların teknoloji ve müzik arasındaki bağlantıyı anlamalarını sağlayacaktır.",
    instructor: "Anaokulu Öğretmenleri",
    duration: "40 dakika",
    prerequisites: "Yok",
  },
  {
    title: "Dash Robot ile Kodlama",
    level: "Anaokulu",
    capacity: "18 öğrenci",
